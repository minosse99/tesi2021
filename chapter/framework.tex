...
\begin{figure}[htbp]
  ...
  \newglossaryentry{server-less}{name={Server-Less},description={}}
  \newglossaryentry{Microservizi}{name={Microservizi},description={}}
  \newglossaryentry{grafo aciclico}{name={Grafo Aciclico},description={}}
